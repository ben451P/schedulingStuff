...
class Scheduler:
    ...
    def schedule_to_class(self):
        ...
        for name, start, end in self.shifts:
            ...
            for g in range(len(guards)):
                print(guards[g].name, guard.name)
    ...
    def convert_to_excel(self):
        ...
        for guard in self.guards:
            print(guard.name, minutes_to_time(guard.start_time), minutes_to_time(guard.end_time), guard.lunch_break_start,minutes_to_time(guard.lunch_break_start))
